...
class UserArgumentFriend {
  final String id;
  UserArgumentFriend(this.id);
}
...
class _FriendProfilePageState extends State<FriendProfilePage> {
  ...
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> userStream =
        context.watch<FriendListProvider>().users;
    final args =
        ModalRoute.of(context)!.settings.arguments as UserArgumentFriend;
